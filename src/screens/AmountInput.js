  ...
  return (
    <ScrollView>
        ...
        <View style={{alignSelf: 'center'}}>
            <TextInput style={{ fontSize: 60, fontWeight: '700', marginVertical: 25}} placeholderStyle={{ color: '#A9A9A9', fontSize: 18 }} placeholder="0.00" />
        </View>
        <Text style={{height: 50, fontSize: 22, textAlign: 'center'}}>Rp 120.000 Available</Text>
        <View  style={styleLocal.noteBar}>
                <Icon2 style={{paddingHorizontal: 20}} name="pencil" size={25} color="#A9A9A9" />
                <TextInput style={{fontSize: 22}} placeholderStyle={{ color: '#A9A9A9', fontSize: 18 }} placeholder="Add some notes" />
            </View>
    </ScrollView>
  );
};
