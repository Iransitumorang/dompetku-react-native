  ...
  return (
    <ScrollView>
        ...
        <View style={styleLocal.ceklis}>
                <Icon name="x" size={80} color="#FFFFFF" />
            </View>
        <Text style={styleLocal.transText}>Transfer Failed</Text>
        <Text style={styleLocal.thereason}>We can’t transfer your money at the moment, we recommend you to check your internet connection and try again.</Text>
